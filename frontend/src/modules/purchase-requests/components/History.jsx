...
const History = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      // Build query parameters - using history endpoint that shows all requests
      ...
      const response = await fetch(`/api/v1/purchase-requests/history?${params}`, {
        headers: {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Complete history of all purchase requests in the system</p>
        </div>
