  ...
  'system-administrator': {
    ...
    configuration: {
      ...
      widgets: [
        {
          ...
          config: { metricType: 'system-health' },
        },
        {
          id: 'active-users',
          type: 'metric',
          ...
          config: { metricType: 'active-users' },
        },
        {
          id: 'server-load',
          type: 'metric',
        ...
        },
        {
          ...
          config: { metricType: 'storage-usage' },
        },
        {
          ...
          config: { chartType: 'line', dataKey: 'user-activity' },
        },
        {
          id: 'system-alerts',
          type: 'list',
          ...
          config: { listType: 'system-alerts', maxItems: 5 },
        },
        {
          id: 'recent-changes',
          type: 'list',
          ...
          config: { listType: 'recent-changes', maxItems: 5 },
        },
        {
      ...
      quickActions: [
        ...
        { id: 'view-logs', label: 'View Logs', icon: 'FileText', route: '/admin/logs' },
